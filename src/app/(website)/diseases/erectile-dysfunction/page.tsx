...
export default function EDPage() {
    return (
        <main>
            <Breadcrumb title="Erectile Dysfunction" />
                        ...
                        <div className="col-lg-7 col-md-12 mb-4 mb-lg-0">
                            <div className="text-white" style={{ maxWidth: "600px" }}>
                                <h1 style={{ fontSize: "3rem", fontWeight: 800 }}>
                                    Ayurvedic <span style={{ color: "#ffb300", fontSize: "larger" }}>Erectile Dysfunction</span><br />
                                    Treatment
                                </h1>
                                ...
                                <div style={{ fontSize: "2rem", color: "#fff", fontWeight: 400 }}>100% Ayurvedic & Holistic ED Solution</div>
                                <div style={{ marginTop: "40px" }}>
                                    <img src="/assets/images/erectile-dysfunction.webp" alt="ED" style={{ maxWidth: "180px", display: "block" }} />
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-5 col-md-12">
                            <EnquiryFormSide disease="Erectile Dysfunction" />
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-7 col-md-12 mb-4 mb-lg-0">
                            <h2 style={{ fontSize: "3rem", fontWeight: 800, color: "#00423b", marginBottom: "24px" }}>
                                What is <span style={{ color: "#ffb300", fontSize: "larger" }}>Erectile Dysfunction?</span>
                            </h2>
                            <p style={{ fontSize: "1.25rem", color: "#18423b", marginBottom: "24px", maxWidth: "800px" }}>
                                Erectile Dysfunction (ED) is a condition where a man is unable to achieve or maintain an erection firm enough for sexual intercourse. It happens when the hormonal and nervous systems don’t send proper signals.
                            </p>
                        ...
                        <div className="col-lg-5 col-md-12 text-center">
                            <div style={{ background: "#fff", borderRadius: "24px", boxShadow: "0 8px 32px rgba(0,0,0,0.08)", padding: "16px 0 0 0", display: "inline-block" }}>
                                <img src="/assets/images/erectile-dysfunction.webp" alt="ED" style={{ maxWidth: "100%", borderRadius: "16px", boxShadow: "0 4px 24px rgba(255,179,0,0.15)" }} />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="container">
                    <div className="row align-items-center">
                        <div className="col-lg-5 col-md-12 mb-4 mb-lg-0 text-center">
                            <img src="/assets/images/erectile-dysfunction.webp" alt="ED" style={{ maxWidth: "340px", borderRadius: "16px", boxShadow: "0 8px 32px rgba(0,0,0,0.10)", background: "#fff", padding: "16px" }} />
                        </div>
                        <div className="col-lg-7 col-md-12">
                            <h2 style={{ fontSize: "2.8rem", fontWeight: 800, color: "#00423b", marginBottom: "18px" }}>
                                What Causes <span style={{ color: "#ffb300", fontSize: "larger" }}>ED?</span>
                            </h2>
                            <ul style={{ fontSize: "1.15rem", color: "#18423b", marginBottom: "18px", listStyleType: "disc", paddingLeft: "24px" }}>
                                <li><b>Diabetes:</b> Affects blood vessels and nerves.</li>
                                <li><b>Depression:</b> Closely linked mental health factor.</li>
                                <li><b>Neurological:</b> Nerve damage from injuries or surgeries.</li>
                            </ul>
                        </div>
                    </div>
                </div>
