                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-lg-5 col-md-12 text-center">
                            <div style={{ background: "#fff", borderRadius: "24px", boxShadow: "0 8px 32px rgba(0,0,0,0.08)", padding: "16px 0 0 0", display: "inline-block" }}>
                                <Image
                                    src="/assets/images/chronic-kidney.webp"
                                    alt="Ayurvedic Kidney Treatment"
                                    width={600}
                                    height={400}
                                    priority
                                    style={{ maxWidth: "100%", height: "auto", borderRadius: "16px", boxShadow: "0 4px 24px rgba(255,179,0,0.15)" }}
                                />
                            </div>
                        </div>
