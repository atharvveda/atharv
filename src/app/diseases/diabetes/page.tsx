                        ...
                        <div className="col-lg-7 col-md-12 mb-4 mb-lg-0">
                            <div className="text-white" style={{ maxWidth: "600px" }}>
                                <h1 style={{ fontSize: "3rem", fontWeight: 800 }}>
                                    Ayurvedic <span style={{ color: "#ffb300", fontSize: "larger" }}>Diabetes</span><br />
                                    Treatment
                                </h1>
                                ...
                                <div style={{ marginTop: "40px" }}>
                                    <img src="/assets/images/liver-cirrhosis.webp" alt="Diabetes" style={{ maxWidth: "180px", display: "block" }} />
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-5 col-md-12">
                            <EnquiryFormSide disease="Diabetes" />
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-7 col-md-12 mb-4 mb-lg-0">
                            <h2 style={{ fontSize: "3rem", fontWeight: 800, color: "#00423b", marginBottom: "24px" }}>
                                What Is <span style={{ color: "#ffb300", fontSize: "larger" }}>Diabetes?</span>
                            </h2>
                            <p style={{ fontSize: "1.25rem", color: "#18423b", marginBottom: "24px", maxWidth: "800px" }}>
                                <b>Diabetes</b> is a chronic condition characterized by elevated blood glucose levels. It occurs when the body either doesn't produce enough insulin or becomes resistant to its effects.
                            </p>
                        ...
                        <div className="col-lg-5 col-md-12 text-center">
                            <div style={{ background: "#fff", borderRadius: "24px", boxShadow: "0 8px 32px rgba(0,0,0,0.08)", padding: "16px 0 0 0", display: "inline-block" }}>
                                <img src="/assets/images/liver-cirrhosis.webp" alt="Diabetes" style={{ maxWidth: "100%", borderRadius: "16px", boxShadow: "0 4px 24px rgba(255,179,0,0.15)" }} />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="row">
                        <div className="col-lg-8">
                            <h2 style={{ fontSize: "2.5rem", fontWeight: 800, color: "#00423b", marginBottom: "18px" }}>
                                Ayurvedic <span style={{ color: "#ffb300", fontSize: "larger" }}>Approach</span>
                            </h2>
                            <div style={{ fontSize: "1.15rem", color: "#18423b" }}>
                                <h4 style={{ color: "#ff5722", fontWeight: 700 }}>Herbal Remedies</h4>
                                <p>Specific herbs like fenugreek, turmeric, jamun, and neem are effective in insulin management.</p>
                                <h4 style={{ color: "#ff5722", fontWeight: 700 }}>Detoxification</h4>
                                <p>Panchakarma helps in cleaning the body mechanisms for better insulin reception.</p>
                            </div>
                        </div>
                        <div className="col-lg-4">
                            <div style={{ background: "#fff", borderRadius: "16px", boxShadow: "0 8px 32px rgba(0,0,0,0.08)", padding: "28px 24px" }}>
                                ...
                                <ul style={{ fontSize: "1.05rem", color: "#18423b", listStyleType: "disc", paddingLeft: "24px" }}>
