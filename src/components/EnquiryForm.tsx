                    ...
                    <div className="col-lg-5 col-md-12">
                        <div className="p-4 bg-white rounded shadow" style={{ maxWidth: "400px", margin: "auto" }}>
                            <form action="https://nocodeform.io/f/68ffa5a79ecb162aca874c37" method="POST">
                                ...
                                <div className="mb-3">
                                    <select name="subject" className="form-control" required defaultValue="" style={{ background: "#f5f5f5", fontWeight: 600 }}>
                                ...
                                <div className="d-grid">
                                    <button type="submit" className="btn btn-warning text-white" style={{ fontSize: "1.2rem", fontWeight: 600, background: "#ff5722", border: "none" }}>
                                        Enquire Now
                                    </button>
                                </div>
                            </form>
